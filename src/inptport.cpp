...
{
#if defined(OGA_TRNGAJE)
	{ IPT_UI_CONFIGURE,         "Config Menu",       SEQ_DEF_4(KEYCODE_TAB, CODE_OR, JOYCODE_1_BUTTON11, JOYCODE_1_BUTTON3) },
#elif defined(OGS_TRNGAJE)
	{ IPT_UI_CONFIGURE,         "Config Menu",       SEQ_DEF_3(KEYCODE_TAB, CODE_OR, JOYCODE_1_BUTTON9) },
#elif defined(RG351P_TRNGAJE)
	{ IPT_UI_CONFIGURE,         "Config Menu",       SEQ_DEF_7(KEYCODE_TAB, CODE_OR, JOYCODE_1_BUTTON10, JOYCODE_1_BUTTON3, CODE_OR, JOYCODE_2_BUTTON12, JOYCODE_2_BUTTON3) }, /* R3 + X */
#else
...
#elif defined(OGS_TRNGAJE)
	{ IPT_UI_PAUSE,             "Pause",             SEQ_DEF_3(KEYCODE_P, CODE_OR, JOYCODE_1_BUTTON14) },
#elif defined(RG351P_TRNGAJE)
	{ IPT_UI_PAUSE,             "Pause",             SEQ_DEF_7(KEYCODE_P, CODE_OR, JOYCODE_1_BUTTON10, JOYCODE_1_BUTTON2, CODE_OR, JOYCODE_2_BUTTON12, JOYCODE_2_BUTTON2) },
#else	
...
#elif defined(OGS_TRNGAJE)
	{ IPT_UI_SHOW_FPS,          "Show FPS",          SEQ_DEF_8(KEYCODE_F11, CODE_NOT, KEYCODE_LCONTROL, CODE_NOT, KEYCODE_LSHIFT, CODE_OR, JOYCODE_1_BUTTON9, JOYCODE_1_BUTTON4) },
#elif defined(RG351P_TRNGAJE)
	{ IPT_UI_SHOW_FPS,          "Show FPS",          SEQ_DEF_11(KEYCODE_F11, CODE_NOT, KEYCODE_LCONTROL, CODE_NOT, KEYCODE_LSHIFT, CODE_OR, JOYCODE_1_BUTTON10, JOYCODE_1_BUTTON4, CODE_OR, JOYCODE_2_BUTTON12, JOYCODE_2_BUTTON4) },
#else
...
#elif defined(OGS_TRNGAJE)
	{ IPT_UI_SNAPSHOT,          "Save Snapshot",     SEQ_DEF_4(KEYCODE_F12, CODE_OR, JOYCODE_1_BUTTON9, JOYCODE_1_BUTTON8) },
#elif defined(RG351P_TRNGAJE)
	{ IPT_UI_SNAPSHOT,          "Save Snapshot",     SEQ_DEF_7(KEYCODE_F12, CODE_OR, JOYCODE_1_BUTTON10, JOYCODE_1_BUTTON12, CODE_OR, JOYCODE_2_BUTTON12, JOYCODE_2_BUTTON10) },
#else
...
#if defined(OGA_TRNGAJE)
	{ IPT_UI_UP,                "UI Up",             SEQ_DEF_5(KEYCODE_UP, CODE_OR, JOYCODE_1_BUTTON7, CODE_OR, JOYCODE_1_UP) },
	{ IPT_UI_DOWN,              "UI Down",           SEQ_DEF_5(KEYCODE_DOWN, CODE_OR, JOYCODE_1_BUTTON8, CODE_OR, JOYCODE_1_DOWN) },
	{ IPT_UI_LEFT,              "UI Left",           SEQ_DEF_5(KEYCODE_LEFT, CODE_OR, JOYCODE_1_BUTTON9, CODE_OR, JOYCODE_1_LEFT) },
	{ IPT_UI_RIGHT,             "UI Right",          SEQ_DEF_5(KEYCODE_RIGHT, CODE_OR, JOYCODE_1_BUTTON10, CODE_OR, JOYCODE_1_RIGHT) },
	...
	{ IPT_UI_SELECT,            "UI Select",         SEQ_DEF_3(KEYCODE_ENTER, CODE_OR, JOYCODE_1_BUTTON2) },
	{ IPT_UI_CANCEL,            "UI Cancel",         SEQ_DEF_3(KEYCODE_ESC, CODE_OR, JOYCODE_1_BUTTON10) },
#elif defined(RG351P_TRNGAJE)
	{ IPT_UI_UP,                "UI Up",             SEQ_DEF_7(KEYCODE_UP, CODE_OR, JOYCODE_1_BUTTON7, CODE_OR, JOYCODE_1_UP, CODE_OR, JOYCODE_2_UP) },
	{ IPT_UI_DOWN,              "UI Down",           SEQ_DEF_7(KEYCODE_DOWN, CODE_OR, JOYCODE_1_BUTTON8, CODE_OR, JOYCODE_1_DOWN, CODE_OR, JOYCODE_2_DOWN) },
	{ IPT_UI_LEFT,              "UI Left",           SEQ_DEF_7(KEYCODE_LEFT, CODE_OR, JOYCODE_1_BUTTON9, CODE_OR, JOYCODE_1_LEFT, CODE_OR, JOYCODE_2_LEFT) },
	{ IPT_UI_RIGHT,             "UI Right",          SEQ_DEF_7(KEYCODE_RIGHT, CODE_OR, JOYCODE_1_BUTTON10, CODE_OR, JOYCODE_1_RIGHT, CODE_OR, JOYCODE_2_RIGHT) },
	{ IPT_UI_SELECT,            "UI Select",         SEQ_DEF_5(KEYCODE_ENTER, CODE_OR, JOYCODE_1_BUTTON2, CODE_OR, JOYCODE_2_BUTTON2) },
	{ IPT_UI_CANCEL,            "UI Cancel",         SEQ_DEF_7(KEYCODE_ESC, CODE_OR, JOYCODE_1_BUTTON9, JOYCODE_1_BUTTON10, CODE_OR, JOYCODE_2_BUTTON11, JOYCODE_2_BUTTON12) }, 
#else
	{ IPT_UI_UP,                "UI Up",             SEQ_DEF_3(KEYCODE_UP, CODE_OR, JOYCODE_1_UP) },
	{ IPT_UI_DOWN,              "UI Down",           SEQ_DEF_3(KEYCODE_DOWN, CODE_OR, JOYCODE_1_DOWN) },
	{ IPT_UI_LEFT,              "UI Left",           SEQ_DEF_3(KEYCODE_LEFT, CODE_OR, JOYCODE_1_LEFT) },
...
#elif defined(OGS_TRNGAJE)
	{ IPT_START1, "1 Player Start",  SEQ_DEF_3(KEYCODE_1, CODE_OR, JOYCODE_1_BUTTON12) },
#elif defined(RG351P_TRNGAJE)
	{ IPT_START1, "1 Player Start",  SEQ_DEF_5(KEYCODE_1, CODE_OR, JOYCODE_1_BUTTON7, CODE_OR, JOYCODE_2_BUTTON10) },	
#else
...
#elif defined(OGS_TRNGAJE)
	{ IPT_COIN1,  "Coin 1",          SEQ_DEF_3(KEYCODE_5, CODE_OR, JOYCODE_1_BUTTON11) },
#elif defined(RG351P_TRNGAJE)
	{ IPT_COIN1,  "Coin 1",          SEQ_DEF_5(KEYCODE_5, CODE_OR, JOYCODE_1_BUTTON8, CODE_OR, JOYCODE_2_BUTTON9) },	
#else
...
#if defined(OGA_TRNGAJE)
	{ IPT_JOYSTICK_UP         | IPF_PLAYER1, "P1 Up",          SEQ_DEF_5(KEYCODE_UP, CODE_OR, JOYCODE_1_BUTTON7, CODE_OR, JOYCODE_1_UP)    },
	{ IPT_JOYSTICK_DOWN       | IPF_PLAYER1, "P1 Down",        SEQ_DEF_5(KEYCODE_DOWN, CODE_OR, JOYCODE_1_BUTTON8, CODE_OR, JOYCODE_1_DOWN)  },
	{ IPT_JOYSTICK_LEFT       | IPF_PLAYER1, "P1 Left",        SEQ_DEF_5(KEYCODE_LEFT, CODE_OR, JOYCODE_1_BUTTON9, CODE_OR, JOYCODE_1_LEFT)  },
	{ IPT_JOYSTICK_RIGHT      | IPF_PLAYER1, "P1 Right",       SEQ_DEF_5(KEYCODE_RIGHT, CODE_OR, JOYCODE_1_BUTTON10, CODE_OR, JOYCODE_1_RIGHT) },
	...
	{ IPT_BUTTON2             | IPF_PLAYER1, "P1 Button 2",    SEQ_DEF_5(KEYCODE_LALT, CODE_OR, JOYCODE_1_BUTTON2, CODE_OR, JOYCODE_1_MOUSE2) },
#else
	{ IPT_JOYSTICK_UP         | IPF_PLAYER1, "P1 Up",          SEQ_DEF_5(KEYCODE_UP, CODE_OR, JOYCODE_1_UP, CODE_OR, JOYCODE_2_UP)    },
	{ IPT_JOYSTICK_DOWN       | IPF_PLAYER1, "P1 Down",        SEQ_DEF_5(KEYCODE_DOWN, CODE_OR, JOYCODE_1_DOWN, CODE_OR, JOYCODE_2_DOWN)  },
	{ IPT_JOYSTICK_LEFT       | IPF_PLAYER1, "P1 Left",        SEQ_DEF_5(KEYCODE_LEFT, CODE_OR, JOYCODE_1_LEFT, CODE_OR, JOYCODE_2_LEFT)  },
	{ IPT_JOYSTICK_RIGHT      | IPF_PLAYER1, "P1 Right",       SEQ_DEF_5(KEYCODE_RIGHT, CODE_OR, JOYCODE_1_RIGHT, CODE_OR, JOYCODE_2_RIGHT) },
	{ IPT_BUTTON1             | IPF_PLAYER1, "P1 Button 1",    SEQ_DEF_5(KEYCODE_LCONTROL, CODE_OR, JOYCODE_1_BUTTON2, CODE_OR, JOYCODE_2_BUTTON2) },
	{ IPT_BUTTON2             | IPF_PLAYER1, "P1 Button 2",    SEQ_DEF_5(KEYCODE_LALT, CODE_OR, JOYCODE_1_BUTTON1, CODE_OR, JOYCODE_2_BUTTON1) },	
#endif

	{ IPT_BUTTON3             | IPF_PLAYER1, "P1 Button 3",    SEQ_DEF_5(KEYCODE_SPACE, CODE_OR, JOYCODE_1_BUTTON3, CODE_OR, JOYCODE_2_BUTTON3) },
	{ IPT_BUTTON4             | IPF_PLAYER1, "P1 Button 4",    SEQ_DEF_3(KEYCODE_LSHIFT, CODE_OR, JOYCODE_1_BUTTON4/*, CODE_OR, JOYCODE_2_BUTTON4*/) },
	...
	{ IPT_BUTTON11            | IPF_PLAYER1, "P1 Button 11",   SEQ_DEF_1(JOYCODE_1_BUTTON11) },
	{ IPT_BUTTON12            | IPF_PLAYER1, "P1 Button 12",   SEQ_DEF_1(JOYCODE_1_BUTTON12) },
	{ IPT_BUTTON13            | IPF_PLAYER1, "P1 Button 13",   SEQ_DEF_1(JOYCODE_1_BUTTON13) },
	{ IPT_BUTTON14            | IPF_PLAYER1, "P1 Button 14",   SEQ_DEF_1(JOYCODE_1_BUTTON14) },
	{ IPT_BUTTON15            | IPF_PLAYER1, "P1 Button 15",   SEQ_DEF_1(JOYCODE_1_BUTTON15) },
	{ IPT_BUTTON16            | IPF_PLAYER1, "P1 Button 16",   SEQ_DEF_1(JOYCODE_1_BUTTON16) },
	{ IPT_BUTTON17            | IPF_PLAYER1, "P1 Button 17",   SEQ_DEF_1(JOYCODE_1_BUTTON17) },
	{ IPT_BUTTON18            | IPF_PLAYER1, "P1 Button 18",   SEQ_DEF_1(JOYCODE_1_BUTTON18) },
	{ IPT_BUTTON19            | IPF_PLAYER1, "P1 Button 19",   SEQ_DEF_1(JOYCODE_1_BUTTON19) },
	{ IPT_BUTTON20            | IPF_PLAYER1, "P1 Button 20",   SEQ_DEF_1(JOYCODE_1_BUTTON20) },
	...
	{ IPT_BUTTON11            | IPF_PLAYER3, "P3 Button 11",   SEQ_DEF_1(JOYCODE_3_BUTTON11) },
	{ IPT_BUTTON12            | IPF_PLAYER3, "P3 Button 12",   SEQ_DEF_1(JOYCODE_3_BUTTON12) },
	{ IPT_BUTTON13            | IPF_PLAYER3, "P3 Button 13",   SEQ_DEF_1(JOYCODE_3_BUTTON13) },
	{ IPT_BUTTON14            | IPF_PLAYER3, "P3 Button 14",   SEQ_DEF_1(JOYCODE_3_BUTTON14) },
	{ IPT_BUTTON15            | IPF_PLAYER3, "P3 Button 15",   SEQ_DEF_1(JOYCODE_3_BUTTON15) },
	{ IPT_BUTTON16            | IPF_PLAYER3, "P3 Button 16",   SEQ_DEF_1(JOYCODE_3_BUTTON16) },
	{ IPT_BUTTON17            | IPF_PLAYER3, "P3 Button 17",   SEQ_DEF_1(JOYCODE_3_BUTTON17) },
	{ IPT_BUTTON18            | IPF_PLAYER3, "P3 Button 18",   SEQ_DEF_1(JOYCODE_3_BUTTON18) },
	{ IPT_BUTTON19            | IPF_PLAYER3, "P3 Button 19",   SEQ_DEF_1(JOYCODE_3_BUTTON19) },
	{ IPT_BUTTON20            | IPF_PLAYER3, "P3 Button 20",   SEQ_DEF_1(JOYCODE_3_BUTTON20) },
	...
	{ IPT_BUTTON11            | IPF_PLAYER4, "P4 Button 11",   SEQ_DEF_1(JOYCODE_4_BUTTON11) },
	{ IPT_BUTTON12            | IPF_PLAYER4, "P4 Button 12",   SEQ_DEF_1(JOYCODE_4_BUTTON12) },
	{ IPT_BUTTON13            | IPF_PLAYER4, "P4 Button 13",   SEQ_DEF_1(JOYCODE_4_BUTTON13) },
	{ IPT_BUTTON14            | IPF_PLAYER4, "P4 Button 14",   SEQ_DEF_1(JOYCODE_4_BUTTON14) },
	{ IPT_BUTTON15            | IPF_PLAYER4, "P4 Button 15",   SEQ_DEF_1(JOYCODE_4_BUTTON15) },
	{ IPT_BUTTON16            | IPF_PLAYER4, "P4 Button 16",   SEQ_DEF_1(JOYCODE_4_BUTTON16) },
	{ IPT_BUTTON17            | IPF_PLAYER4, "P4 Button 17",   SEQ_DEF_1(JOYCODE_4_BUTTON17) },
	{ IPT_BUTTON18            | IPF_PLAYER4, "P4 Button 18",   SEQ_DEF_1(JOYCODE_4_BUTTON18) },
	{ IPT_BUTTON19            | IPF_PLAYER4, "P4 Button 19",   SEQ_DEF_1(JOYCODE_4_BUTTON19) },
	{ IPT_BUTTON20            | IPF_PLAYER4, "P4 Button 20",   SEQ_DEF_1(JOYCODE_4_BUTTON20) },

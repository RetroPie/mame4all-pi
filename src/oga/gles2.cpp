...
void gles2_create(int display_width, int display_height, int bitmap_width, int bitmap_height, int depth)
{
	...
	printf("[trngaje] gles2.cpp:gles2_create++:%d,%d,%d,%d,%d\n", display_width, display_height, bitmap_width, bitmap_height, depth);
	...
	printf("[trngaje] gles2.cpp:gles2_create:step2=shader.program=%x\n", shader.program);
#if 1 // removed by trngaje
	if(shader.program)
	{
...
#endif
	printf("[trngaje] gles2.cpp:gles2_create:step2-1\n");
	glGenTextures(2, textures);	SHOW_ERROR
	printf("[trngaje] gles2.cpp:gles2_create:step3\n");
	...
	printf("[trngaje] gles2.cpp:gles2_create:step4\n");
	...
	printf("[trngaje] gles2.cpp:gles2_create:step5\n");
    ...
    palette_changed = 1;
	printf("[trngaje] gles2.cpp:gles2_create--\n");
}
